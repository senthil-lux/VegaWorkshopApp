...
shaka.util.XmlUtils = class {
  ...
  /**
   * Set native function to parse a string into
   * XML document.
   * @param {function(string):Element} parseFromString
   */
  static setNativeFunctions(parseFromString) {}
};
/**
...
shaka.hls.Tag = class {
  /**
   * @param {number} id
   * @param {shaka.hls.TAGNAME} name
   * @param {Map<shaka.hls.ATTRIBUTENAME, string>} attributes
   * @param {?string=} value
   */
  constructor(id, name, attributes, value) {}
};
/**
 * HLS segment class.
 */
shaka.hls.Segment = class {
   ...
   * @param {!Map.<shaka.hls.TAGNAME, shaka.hls.Tag>} tags
...
shaka.hls.Attribute = class {
   ...
   * @param {shaka.hls.ATTRIBUTENAME} name
   * @param {string} value
   */
  constructor(name, value) {}
};
/**
 * Match this enum to native
 * @enum {number}
 * @public
 */
shaka.hls.TAGNAME = {
  ...
  EXT_X_CUE_IN: 8,
  SYS_SYMBOL_END: 9,
  SEGMENT_TAGS_START: 10,
  EXTINF: 11,
  EXT_X_BYTERANGE: 12,
  EXT_X_DISCONTINUITY: 13,
  EXT_X_PROGRAM_DATE_TIME: 14,
  EXT_X_KEY: 15,
  EXT_X_DATERANGE: 16,
  EXT_X_MAP: 17,
  EXT_X_GAP: 18,
  SEGMENT_TAGS_END: 19,
  MEDIA_PLAYLIST_TAGS_START: 20,
  EXT_X_TARGETDURATION: 21,
  EXT_X_MEDIA_SEQUENCE: 22,
  EXT_X_DISCONTINUITY_SEQUENCE: 23,
  EXT_X_PLAYLIST_TYPE: 24,
  EXT_X_I_FRAMES_ONLY: 25,
  EXT_X_ENDLIST: 26,
  EXT_X_SERVER_CONTROL: 27,
  EXT_X_SKIP: 28,
  EXT_X_DEFINE: 29,
  EXT_X_TILES: 30,
  MEDIA_PLAYLIST_TAGS_END: 31,
  EXT_X_IMAGE_STREAM_INF: 32,
  EXT_X_SESSION_KEY: 33,
  EXT_X_SESSION_DATA: 34,
  EXT_X_PART_INF: 35,
  EXT_X_INDEPENDENT_SEGMENTS: 36,
  EXT_X_PART: 37,
  EXT_X_PRELOAD_HINT: 38,
  EXT_X_CONTENT_STEERING: 39,
  EXT_X_I_FRAME_STREAM_INF: 40,
  EXT_X_BITRATE: 41,
  USP_X_MEDIA: 42,
  EXT_X_START: 43,
  EXT_X_RENDITION_REPORT: 44
};
/**
 * Match this enum to native
 * @enum {number}
 * @public
 */
shaka.hls.ATTRIBUTENAME = {
  BANDWIDTH: 1,
  AVERAGE_BANDWIDTH: 2,
  SCORE: 3,
  CODECS: 4,
  SUPPLEMENTAL_CODECS: 5,
  RESOLUTION: 6,
  FRAME_RATE: 7,
  HDCP_LEVEL: 8,
  ALLOWED_CPC: 9,
  ...
  SCTE35_IN: 70,
  END_ON_NEXT: 71,
  RECENTLY_REMOVED_DATERANGES: 72,
  LAST_MSN: 73,
  LAST_PART: 74
};
/**
...
shaka.hls.HlsParser = class {
   ...
   * @param {function(BufferSource, string, boolean):
   *     Array.<shaka.hls.Playlist>} parsePlaylistFn
   */
  static setNativeFunctions(parsePlaylistFn) {}
};
/**
